...
# Note: In my experience, this step takes a REALLY long time (~12.5 hours).
# You may want to download these files ahead of time and use the COPY directive instead.
...
RUN git clone -b database-cache --single-branch https://github.com/hydrusbeta/so_vits_svc_5_server ~/hay_say/so_vits_svc_5_server/
